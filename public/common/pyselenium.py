    ...
    def __init__(self, browser='chrome', remoteAddress=None):
        ...
        if remoteAddress is None:
            if browser == "firefox" or browser == "ff":
                dr = webdriver.Firefox(globalparam.driver_path + '/' + 'geckodriver')
            elif browser == "chrome" or browser == "Chrome":
                # dr.options.addArguments("--disable-infobars")
                chrome_options = Options()
                chrome_options.add_argument("--disable-infobars")
                dr = webdriver.Chrome(globalparam.driver_path + '/' + 'chromedriver.exe', chrome_options=chrome_options)
