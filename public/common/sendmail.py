...
logger = Log()
# 配置收发件人
recvaddress = ['aaa@aaa.com', 'drtest01@126.com']
# 163的用户名和密码
sendaddr_name = 'aaa@aaa.com'
sendaddr_pswd = '********'
...
class SendMail:
	...
	def __take_messages(self):
		...
		att1["Content-Disposition"] = 'attachment; filename="Jingoal-TestReport.html"'#这里的filename可以任意写，写什么名字，邮件中显示什么名字
	...
	def send(self):
		...
		try:
			smtp = smtplib.SMTP('mail.kmhealthcloud.com', 587)
